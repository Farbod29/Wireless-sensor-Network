...
public class GraphicalPannel extends JPanel {
	/**
	 * 
	 */
	...
	public GraphicalPannel(List<Double> scores) {
		this.scores = scores;

	}

	public GraphicalPannel() {
		...
		for (int i = 0; i < numberYDivisions + 1; i++) {
			...
			if (scores.size() > 0) {
				...
				String yLabel = ((int) ((getMinScore()
						+ (getMaxScore() - getMinScore()) * ((i * 1.0) / numberYDivisions)) * -100)) / 100.0 + "";// inja
																													// gand
																													// zad
	...
	public static void createAndShowGui( int round, int linkNumber) {
		...
		// ===================================================================
		// ===================================================================================
		list2 = Parser.parser(round, linkNumber);
		scores.addAll(list2);
		// =============================
		...
		JFrame frame = new JFrame("channel");
	...
	static class MainPanel extends JPanel {
		...
		public MainPanel(List<Double> scores) {
			...
			JLabel title = new JLabel("Variation of RSS with time");
			title.setFont(new Font("Arial", Font.BOLD, 25));
			title.setHorizontalAlignment(JLabel.CENTER);

			JPanel GraphicalPannel = new GraphicalPannel(scores);
			...
			add(GraphicalPannel, BorderLayout.CENTER);
